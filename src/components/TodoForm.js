    ...
    export const TodoForm = ({ addTodo }) => {
        ...
        return(   
                <form className ="TodoForm pt-5" onSubmit = {handleSubmit}>
                    ...
                    <button type="submit" className="TodoButton bg-gray-600 text-gray-300 text-xl hover:bg-gray-500 transform transition-transform duration-300 hover:scale-90">Add  Task</button>
                </form>
